		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Characteristic Value Option Percentages",
									"targetURL": "#cpappvcpcharvaloptpercent-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cpappvcpcharvaloptpercent-display": {
								"semanticObject": "cpappvcpcharvaloptpercent",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cpapp.vcpcharvaloptpercent",
									"url": sap.ui.require.toUrl("cpapp/vcpcharvaloptpercent")
								}
							}
						}
					}
